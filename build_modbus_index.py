...
def build_index(reports: list[dict[str, Any]], now_override: str | None = None) -> str:
    ...
    for r in reports:
        ...
        parts.append("<tr>")
        parts.append(
            f"<td><a href='modbus_batch/{html_lib.escape(r['html'])}'>"
    ...
    new Chart(document.getElementById('chartPackets'), {
        ...
        data: {
            ...
            datasets: [
                ...
                { label: 'Modbus Packets', data: modbusPackets, backgroundColor: 'rgba(75, 192, 192, 0.6)' }
            ]
        },
        options: {
            responsive: true,
    ...
    parts.append(
        "<li>Values in red indicate suspect Modbus functions (e.g., Write Multiple "
...
if __name__ == "__main__":
    ...
    if not reports:
        ...
        with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
            f.write(html)
        print(f"[OK] Global Modbus index generated at {OUTPUT_FILE}")
